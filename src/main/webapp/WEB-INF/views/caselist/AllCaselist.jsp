...
<link href="${pageContext.request.contextPath}/css/AllCaselist.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/tablefilter/style/tablefilter.css" rel="stylesheet">
